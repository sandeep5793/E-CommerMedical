...
public class ApiController {
    ...
    void setMerchantServerUrl(String url) {
        merchantServerUrl = url;
    }

    void createSession(final CreateSessionCallback callback) {
        ...
        new Thread(() -> {
            ...
            try {
                /// Step 2. Leading to create session request and some interfaces are initialising to receive call-backs
    ...
    private Pair<String, String> executeCreateSession() throws Exception {
        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "/session.php"),
                "", "POST", "120810000016", "9d1440a505bee98c6a8ec53955fd83dd", HttpsURLConnection.HTTP_OK);

                 // Step 3. It Create url to exicute request to server and get response in jsonResponse object,
        //                  merchantUrl is the url define in Config file.
        //                  Password and username are the keys that you have provided.
        //                  These are the only parameter during creating session.


        GatewayMap response = new GatewayMap(jsonResponse);
        Log.d("createSession",response.toString());
    ...
    private GatewayMap executeCheck3DSEnrollment(String sessionId, String amount, String currency, String threeDSecureId) throws Exception {
        ...
        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "/3DSecure.php?3DSecureId=" + threeDSecureId), jsonRequest, "PUT", "120810000016", "9d1440a505bee98c6a8ec53955fd83dd", HttpsURLConnection.HTTP_OK);

        GatewayMap response = new GatewayMap(jsonResponse);
        Log.d("3DSEnrollmentResponse",response.values().toString());
    ...
    private String executeCompleteSession(String sessionId, String orderId, String transactionId, String amount, String currency, String threeDSecureId, Boolean isGooglePay) throws Exception {
        GatewayMap request = new GatewayMap()
        ...
        String jsonResponse = doJsonRequest(new URL(merchantServerUrl + "/transaction.php?order=" + orderId + "&transaction=" + transactionId), jsonRequest, "PUT", "120810000016", "9d1440a505bee98c6a8ec53955fd83dd", HttpsURLConnection.HTTP_OK);
    ...
    int makeJsonRequest(HttpURLConnection connection, String method, String json,
        ...
        //This is the final request to server to get response
