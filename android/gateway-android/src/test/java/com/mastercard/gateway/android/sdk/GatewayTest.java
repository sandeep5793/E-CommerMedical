...
public class GatewayTest {
    ...
    public void testGetApiUrlWorksAsIntended() throws Exception {
        ...
        String expectedUrl = "https://test-adcb.mtf.gateway.mastercard.com/api/rest/version/" + Gateway.MIN_API_VERSION;
    ...
    public void testGetUpdateSessionUrlWorksAsIntended() throws Exception {
        ...
        gateway.region = Gateway.Region.NORTH_AMERICA;
        String expectedUrl = "https://test-adcb.mtf.gateway.mastercard.com/api/rest/version/" + Gateway.MIN_API_VERSION + "/merchant/somemerchant/session/sess1234";
