...
//    static final String USER_AGENT = "Gateway-Android-SDK/" + BuildConfig.VERSION_NAME;
    static final String USER_AGENT = "Gateway-Android-SDK/" + "1.1.3";
...
//        ret urn "https://" + region.getPrefix() + "gateway.mastercard.com/api/rest/version/" + apiVersion;

        Log.d("getaapiurl","https://test-adcb.mtf.gateway.mastercard.com/api/rest/version/" + apiVersion);
        return "https://adcb.gateway.mastercard.com/api/rest/version/" + apiVersion;
//        return "http://premizer.com/developer/mobilesdk/mpgs/api/rest/version/" + apiVersion;
    }
